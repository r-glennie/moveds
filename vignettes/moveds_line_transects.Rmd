...
```{r load_data}
data("example_mds_line")
str(example_mds_line) 
obs <- example_mds_line$obs
trans <- example_mds_line$trans
```
...
plot(x, g.cds1d, type = "l", xlab = "Perpendicular Distance", ylab = "Detection Probability")
